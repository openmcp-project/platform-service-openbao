...
// ControlPlaneEntitySpec defines the desired state of ControlPlaneEntity
type ControlPlaneEntitySpec struct {
	...
	// foo is an example field of ControlPlaneEntity. Edit controlplaneentity_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// ControlPlaneEntityStatus defines the observed state of ControlPlaneEntity.
type ControlPlaneEntityStatus struct {
	...
	// conditions represent the current state of the ControlPlaneEntity resource.
...
// ControlPlaneEntity is the Schema for the controlplaneentities API
